  ...
  return (
    <section className="about-container">
      <div className="left-container">
        <h2>8216 SHIBA WARRIORS</h2>
      </div>
      <div className="right-container">
        <p>
          Deep in the the middle of “Fuji no jukai” lies a pack of 8.216 Shiba
          Inus, waiting and preparing for the war – World War 0! They represent
          confidence, strength and hate being underestimated because of their
          "cute" appearance. A well-intentioned advice: better not mess with
